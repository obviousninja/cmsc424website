...
$(document).ready(function(){
    ...
    $("#loginBox").css({"top": ((screen.height-500)/2).toString()+"px",
                    "left": ((screen.width-400)/2).toString()+"px",
                    "backgroundColor":"transparent",
                    "height":"130px", "width":"400px",
                    "position":"absolute"});
    
    var h = (((screen.height-500)/2)+120).toString()+"px";
    var h2 = (((screen.height-500)/2)+160).toString()+"px";
    var wid = (((screen.width-400)/2)+200).toString() + "px";
